...
public class CountProductByStatusStorage implements DatasetProducer, CategoryToolTipGenerator, CategoryItemLinkGenerator, Serializable {
	...
	public String generateToolTip(CategoryDataset data, int series, int item) {
		...
		DefaultPieDataset dataset = dao.getCountProductByStatusStorage();
	...
	public Object produceDataset(Map params) throws DatasetProduceException {
		...
		DAOReports dao = new DAOReports();
		return dao.getCountProductByStatusStorage();
	}
